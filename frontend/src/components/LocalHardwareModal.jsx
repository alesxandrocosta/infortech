  ...
  return (
    <div className="modal-backdrop" role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) onClose(); }}>
      <div className="modal-panel hardware-modal" role="dialog" aria-modal="true" aria-labelledby="hardware-modal-title">
        ...
        <p className="panel-subtitle">A leitura é feita pelo agente local desta máquina, não pelo servidor. Execute iniciar-cliente-agent.cmd nesta máquina antes de ler.</p>
